...
|-----------------|-----------------------|----------------------------------------------------------------------|---------------------------------------------------------------------------|
| BOOT_BUTTON     | BUTTON_CUSYOMV1        | [Link](https://ro.mouser.com/ProductDetail/Panasonic/EVQ-P7L01P)     | [Datasheet](https://componentsearchengine.com/Datasheets/2/EVQP7L01P.pdf) |
